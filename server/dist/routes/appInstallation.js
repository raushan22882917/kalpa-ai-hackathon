 ...
 */
router.post('/upload', upload.single('appPackage'), async (req, res) => {
    try {
        ...
        const filePath = await appInstallationService.saveAppPackage(deviceId, file.originalname, file.buffer);
        // Install the app
